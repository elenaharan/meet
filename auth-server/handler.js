...
/*SCOPES allows to set acces levels; this is set to readonly for now because you don't have access rights to update calendar yourself*/
const SCOPES = ["https://www.googleapis.com/auth/calendar.readonly"];

/*Credentials are values required to get access to your calendar. If you see "process.end" this means the value is in the "config.json" file. This is the best practice as it keeps API secrets hidden.*/
const credentials = {
  ...
  redirect_uris: ["https://elenaharan.github.io/meet"],
  javascript_origins: ["https://elenaharan.github.io", "http://localhost:3000"],
};
